...
import { MicroserviceFilterboxComponent } from 'components/microserviceFilterbox';
...
describe('<MicroserviceFilterbox/>', () => {
  ...
  it('displays login, show versions & share link button in menu when no user is logged in', () => {
    const props = createProps();
  ...
  it('displays logout, add service, add link, show versions & share link buttons in menu when a user is logged in', () => {
    const props = createProps();
  ...
  it('displays show hidden services button when there are hidden services', () => {
    const props = createProps();
  ...
  it('dispatches UNHIDE_SERVICE action', () => {
    const props = createProps();
    props.hiddenMicroServices = [{ id: 1337 }];
  ...
  it('dispatches SHOW_VERSIONS action', () => {
    const props = createProps();
  ...
  it('dispatches HIDE_VERSIONS action', () => {
    const props = createProps();
