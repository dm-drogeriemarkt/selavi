...
public class PersonActiveDirectoryServiceTest {

    private PersonActiveDirectoryService personActiveDirectoryService;
    ...
    @Before
    public void init() {
        personActiveDirectoryService = new PersonActiveDirectoryService(ldapTemplate);
    }
    ...
    public void findByName() {
        ...
        final List<Person> result = personActiveDirectoryService.findByName("Bob");
